    ...
    <section className="mx-auto max-w-4xl space-y-8 px-6 py-16">
      <div className="space-y-4">
        ...
        <p className="text-lg text-slate-600">
          Resacolo fédère des professionnels engagés autour des colonies de vacances. Chaque structure dispose d’un
          espace dédié et d’une synchronisation automatique de ses séjours.
        </p>
      </div>
