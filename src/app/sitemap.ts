...
const PUBLIC_STATIC_PATHS: Array<{
  ...
  { path: '/notre-concept', changeFrequency: 'monthly', priority: 0.6 },
  { path: '/devenir-partenaire', changeFrequency: 'monthly', priority: 0.5 },
  { path: '/partenaire', changeFrequency: 'monthly', priority: 0.5 },
